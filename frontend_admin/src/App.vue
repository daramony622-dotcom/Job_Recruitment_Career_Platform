...
// 🟢 ប្តូរមកប្រើ Relative path វិញនៅទីនេះ
...
<template>
  ...
  <div v-else class="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
    <!-- Sidebar -->
    <aside
      class="fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transition-transform lg:translate-x-0"
    ...
    >
      <div class="flex items-center gap-3 px-6 h-16 border-b border-slate-200 dark:border-slate-800 shrink-0">
        ...
        <div>
          <p class="font-bold text-slate-900 dark:text-slate-100 leading-tight">Recruit Admin</p>
          <p class="text-xs text-slate-600 dark:text-slate-400">Management Console</p>
        </div>
      </div>
      ...
      <div class="absolute bottom-0 left-0 right-0 p-3 border-t border-slate-200 dark:border-slate-800 space-y-1">
        <div class="flex items-center gap-3 px-3 py-2.5 rounded-lg">
          <div class="w-8 h-8 rounded-full bg-slate-300 dark:bg-slate-700 flex items-center justify-center text-xs font-bold text-slate-800 dark:text-slate-200 uppercase">
    ...
    <div class="lg:pl-64 flex flex-col min-h-screen">
      ...
      <header class="sticky top-0 z-20 h-16 bg-white/95 dark:bg-slate-900/95 backdrop-blur border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 sm:px-6 gap-4">
        <div class="flex items-center gap-3 min-w-0">
          <button
            class="lg:hidden p-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100"
        ...
        <div class="flex items-center gap-3 ml-auto">
          ...
          <button class="relative p-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 rounded-lg transition-colors" aria-label="Notifications">
            <Bell class="w-5 h-5" />
