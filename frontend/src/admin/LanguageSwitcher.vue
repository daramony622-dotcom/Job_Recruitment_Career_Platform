<template>
  <div class="language-switcher relative inline-block">
    <button
      ...
      class="admin-control language-control cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/30"
...
import FlagIcon from '../client/FlagIcon.vue'
