...
const lastPage = computed(() => Math.max(1, Math.ceil(filteredLogs.value.length / perPage)))

watch([searchQuery, selectedStatusFilter], () => { currentPage.value = 1 })
        ...
        <div class="panel-heading mb-4 flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div class="flex flex-wrap items-center gap-2">
            ...
            <div class="relative min-w-45">
              ...
              <label for="security-audit-search" class="sr-only">Search audit events</label>
              <input
            ...
            <!-- Status filter -->
            <label for="security-status-filter" class="sr-only">Filter audit status</label>
            <select
