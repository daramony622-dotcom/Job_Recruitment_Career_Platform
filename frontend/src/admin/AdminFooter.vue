...
<template>
  <footer class="admin-footer mt-auto border-t border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-4 text-slate-700 dark:text-slate-300 sm:px-6 shadow-xs">
