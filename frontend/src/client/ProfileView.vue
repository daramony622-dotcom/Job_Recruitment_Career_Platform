  ...
  <div class="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100 antialiased transition-colors duration-200">
      ...
      <div class="w-full max-w-2xl space-y-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900 sm:p-8">
        ...
        <form @submit.prevent="saveCareerItem" class="grid grid-cols-1 gap-4 text-xs sm:grid-cols-2">
          ...
          <template v-if="careerType === 'education'">
            <label class="space-y-1"><span class="font-bold text-slate-700 dark:text-slate-300">Institution name</span><input v-model="careerForm.institution_name" required type="text" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" /></label>
            <label class="space-y-1"><span class="font-bold text-slate-700 dark:text-slate-300">Degree</span><input v-model="careerForm.degree" required type="text" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" /></label>
            <label class="space-y-1"><span class="font-bold text-slate-700 dark:text-slate-300">Field of study</span><input v-model="careerForm.field_of_study" type="text" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" /></label>
            <label class="space-y-1"><span class="font-bold text-slate-700 dark:text-slate-300">Grade</span><input v-model="careerForm.grade" type="text" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" /></label>
            <label class="space-y-1"><span class="font-bold text-slate-700 dark:text-slate-300">Start date</span><input v-model="careerForm.start_date" required type="date" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" /></label>
            <label class="space-y-1"><span class="font-bold text-slate-700 dark:text-slate-300">End date</span><input v-model="careerForm.end_date" :disabled="careerForm.is_current" type="date" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs disabled:opacity-50" /></label>
            <label class="flex items-center gap-2 font-bold text-slate-700 dark:text-slate-300 sm:col-span-2 cursor-pointer select-none"><input v-model="careerForm.is_current" type="checkbox" class="h-4 w-4 rounded text-blue-600" /> I am currently studying here</label>
            <label class="space-y-1 sm:col-span-2"><span class="font-bold text-slate-700 dark:text-slate-300">Description</span><textarea v-model="careerForm.description" rows="3" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs resize-none"></textarea></label>
          </template>
          <template v-else>
            <label class="space-y-1"><span class="font-bold text-slate-700 dark:text-slate-300">Job title</span><input v-model="careerForm.job_title" required type="text" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" /></label>
            <label class="space-y-1"><span class="font-bold text-slate-700 dark:text-slate-300">Company name</span><input v-model="careerForm.company_name" required type="text" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" /></label>
            <label class="space-y-1 sm:col-span-2"><span class="font-bold text-slate-700 dark:text-slate-300">Location</span><input v-model="careerForm.location" type="text" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" /></label>
            <label class="space-y-1"><span class="font-bold text-slate-700 dark:text-slate-300">Start date</span><input v-model="careerForm.start_date" required type="date" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" /></label>
            <label class="space-y-1"><span class="font-bold text-slate-700 dark:text-slate-300">End date</span><input v-model="careerForm.end_date" :disabled="careerForm.is_current" type="date" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs disabled:opacity-50" /></label>
            <label class="flex items-center gap-2 font-bold text-slate-700 dark:text-slate-300 sm:col-span-2 cursor-pointer select-none"><input v-model="careerForm.is_current" type="checkbox" class="h-4 w-4 rounded text-blue-600" /> I currently work here</label>
            <label class="space-y-1 sm:col-span-2"><span class="font-bold text-slate-700 dark:text-slate-300">Description</span><textarea v-model="careerForm.description" rows="3" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs resize-none"></textarea></label>
          </template>
          <div class="flex justify-end gap-3 border-t border-slate-100 pt-4 dark:border-slate-800 sm:col-span-2"><button type="button" @click="closeCareerModal" class="rounded-xl bg-slate-100 px-4 py-2.5 font-bold text-slate-700 dark:bg-slate-800 dark:text-slate-200">Cancel</button><button type="submit" :disabled="isCareerSaving" class="rounded-xl bg-blue-600 hover:bg-blue-700 px-5 py-2.5 font-bold text-white shadow-md shadow-blue-500/20 disabled:opacity-60">{{ isCareerSaving ? 'Saving...' : 'Save record' }}</button></div>
        </form>
      </div>
    </div>
    ...
    <div v-if="showSkillsModal" class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-slate-950/60 p-4 backdrop-blur-xs">
      <div class="w-full max-w-2xl space-y-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900 sm:p-8">
        ...
        <input v-model="skillSearch" @input="loadSkillCatalog" type="search" placeholder="Search skills or categories" class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" />
        ...
        <div class="space-y-3 rounded-2xl border border-amber-100 bg-amber-50/60 p-4 dark:border-amber-900/50 dark:bg-amber-950/20"><p class="text-xs font-extrabold text-slate-800 dark:text-slate-200">Add your own skill</p><div class="flex gap-2"><input v-model="customSkillName" @keyup.enter="addCustomSkill" type="text" maxlength="100" placeholder="Example: Khmer copywriting" class="w-full px-3.5 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-medium text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-xs" /><button type="button" @click="addCustomSkill" :disabled="isCustomSkillSaving || !customSkillName.trim()" class="shrink-0 rounded-xl bg-amber-500 hover:bg-amber-600 px-4 py-2 text-xs font-bold text-white disabled:opacity-50">{{ isCustomSkillSaving ? 'Adding...' : 'Add' }}</button></div><div v-if="customSkills.length" class="flex flex-wrap gap-2"><button v-for="skill in customSkills" :key="`remove-${skill}`" type="button" @click="removeCustomSkill(skill)" class="inline-flex items-center gap-1 rounded-lg bg-white px-2.5 py-1.5 text-[11px] font-bold text-amber-800 shadow-sm dark:bg-slate-900 dark:text-amber-300" title="Remove custom skill">{{ skill }} <X class="h-3 w-3" /></button></div></div>
        <div class="flex justify-end gap-3 border-t border-slate-100 pt-4 dark:border-slate-800"><button type="button" @click="showSkillsModal = false" class="rounded-xl bg-slate-100 px-4 py-2.5 text-xs font-bold text-slate-700 dark:bg-slate-800 dark:text-slate-200">Cancel</button><button type="button" @click="saveSkills" :disabled="isSkillsSaving" class="rounded-xl bg-emerald-600 hover:bg-emerald-700 px-5 py-2.5 text-xs font-bold text-white shadow-md shadow-emerald-500/20 disabled:opacity-60">{{ isSkillsSaving ? 'Saving...' : `Save ${skills.length + customSkills.length} skills` }}</button></div>
      </div>
    </div>
