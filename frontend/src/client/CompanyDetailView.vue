  ...
  >
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      >
        <!-- Cover Photo Banner -->
        <div
          class="h-44 sm:h-56 w-full relative overflow-hidden bg-linear-to-r from-blue-700 via-blue-600 to-indigo-900"
        >
          <img
          ...
          />
          <div
            class="absolute inset-0 bg-linear-to-t from-slate-950/70 via-transparent to-transparent"
          ></div>
        ...
        >
          <div class="flex items-start md:items-end gap-5">
            ...
            <div
              v-else
              class="w-24 h-24 md:w-28 md:h-28 rounded-3xl bg-linear-to-br from-blue-600 to-indigo-700 text-white font-extrabold text-3xl flex items-center justify-center border-4 border-white dark:border-slate-900 shadow-xl shrink-0"
            >
            ...
            <div class="space-y-1 pt-2">
              <div class="flex items-center gap-2 flex-wrap">
                ...
                >
                  <span class="notranslate" translate="no">{{ company.name }}</span>
                </h1>
                <ShieldCheck
                  v-if="company.is_verified"
              ...
              >
                <Building2 class="w-4 h-4" /> <span class="notranslate" translate="no">{{ company.industry }}</span>
              </p>
        ...
        <div class="lg:col-span-2 space-y-8">
          ...
          >
            <h2 class="text-lg font-extrabold text-slate-900 dark:text-white">
              About <span class="notranslate" translate="no">{{ company.name }}</span>
            </h2>
            <p
