...
<template>
  <div class="min-h-screen bg-slate-50/60 dark:bg-[#070c16] font-sans text-slate-900 dark:text-slate-100 antialiased transition-colors duration-300">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <section class="site-banner site-banner-compact relative rounded-3xl overflow-hidden bg-cover bg-center px-6 sm:px-10 py-10 sm:py-12 text-white shadow-xl bg-[url('https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=1920&auto=format&fit=crop')] border border-blue-900/40">
        ...
        <div class="relative z-10 max-w-3xl space-y-3">
          <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-xs font-bold uppercase tracking-wider text-cyan-200 border border-white/15">
            <Building2 class="w-3.5 h-3.5" /> Verified Employers
          </span>
          <h1 class="site-banner-title font-extrabold tracking-tight text-white">
            Discover Great Companies & Work Teams
          </h1>
          <p class="site-banner-copy text-slate-200 font-medium">
            Explore verified employer profiles, team cultures, company sizes, and active open roles across top organizations.
          </p>
        </div>
      </section>
