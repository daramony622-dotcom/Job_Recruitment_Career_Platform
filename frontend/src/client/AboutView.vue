...
<template>
  <div class="min-h-screen bg-slate-50/60 dark:bg-[#070c16] font-sans text-slate-900 dark:text-slate-100 antialiased transition-colors duration-300">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-14">
      ...
      <section class="site-banner site-banner-compact relative rounded-3xl overflow-hidden bg-cover bg-center px-6 sm:px-12 py-10 sm:py-14 text-white shadow-xl bg-[url('https://images.unsplash.com/photo-1521737711867-e3b97375f902?q=80&w=1920&auto=format&fit=crop')] border border-blue-900/40">
        ...
        <div class="relative z-10 max-w-3xl space-y-5">
          <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-semibold text-cyan-200">
          ...
          <h1 class="text-3xl sm:text-5xl font-extrabold tracking-tight leading-tight text-white">
            ...
            <span class="text-cyan-300">Connecting Top Talent & Work Teams.</span>
          </h1>
          ...
          <div class="flex flex-wrap items-center gap-3 pt-2">
            <router-link to="/jobs" class="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 border border-blue-500/30 text-white rounded-2xl text-xs font-bold transition shadow-md shadow-blue-500/20 active:scale-95">
              <span>Browse 12,400+ Jobs</span>
              <ArrowRight class="w-4 h-4" />
            </router-link>
            <router-link to="/contact" class="inline-flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 border border-white/20 text-white rounded-2xl text-xs font-bold transition active:scale-95 backdrop-blur-xs">
              <Mail class="w-4 h-4" />
      ...
      <section class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div 
          v-for="st in stats" 
          :key="st.label"
          class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl text-center space-y-2 shadow-xs hover:shadow-md transition"
        >
          <div class="p-3 bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-cyan-400 rounded-2xl w-12 h-12 mx-auto flex items-center justify-center">
      ...
      <section class="space-y-8">
        <div class="text-center max-w-2xl mx-auto space-y-2">
          <span class="px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-cyan-400 text-xs font-bold uppercase tracking-wider">
            Platform Capability
          </span>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div 
            ...
            :key="fn.title"
            class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl space-y-4 shadow-xs hover:shadow-md transition"
          >
      ...
      <section class="space-y-8">
        <div class="text-center max-w-2xl mx-auto space-y-2">
          <span class="px-3 py-1 rounded-full bg-[#0b1329]/10 dark:bg-slate-800 text-[#0b1329] dark:text-cyan-400 text-xs font-bold uppercase tracking-wider">
            Meet The Engineers
          </span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div 
            ...
            :key="member.name"
            class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 sm:p-8 space-y-5 shadow-xs hover:shadow-lg flex flex-col justify-between relative group transition"
          >
            ...
            <div class="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-center gap-3">
              <a 
                ...
                class="p-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-[#0b1329] hover:text-white dark:hover:bg-cyan-600 text-slate-600 dark:text-slate-300 rounded-xl transition cursor-pointer" 
      ...
      <section class="site-banner site-banner-cta relative rounded-3xl overflow-hidden bg-cover bg-center p-8 sm:p-12 text-white shadow-xl bg-[url('https://images.unsplash.com/photo-1534536281715-e28d76689b4d?q=80&w=1920&auto=format&fit=crop')] border border-blue-900/40 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div class="absolute inset-0 bg-gradient-to-r from-black/65 via-black/45 to-black/25"></div>
        <div class="relative z-10 space-y-2 max-w-xl">
          <h2 class="text-2xl sm:text-3xl font-extrabold tracking-tight text-white">Have Questions or Need Assistance?</h2>
          <p class="text-xs sm:text-sm text-slate-200">Our team and support specialists are here to assist candidates and hiring employers 24/7.</p>
        </div>

        <router-link to="/contact" class="relative z-10 inline-flex items-center gap-2 px-6 py-3.5 bg-white text-[#0b1329] hover:bg-slate-100 rounded-2xl text-xs font-bold transition shadow-md shrink-0 active:scale-95">
          <Send class="w-4 h-4" />
