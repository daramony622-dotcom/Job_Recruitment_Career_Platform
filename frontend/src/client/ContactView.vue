...
<template>
  <div class="min-h-screen bg-slate-50/60 dark:bg-[#070c16] font-sans text-slate-900 dark:text-slate-100 antialiased transition-colors duration-300">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      <!-- ─── 1. Page Hero Banner ───────────────────────────────────────── -->
      <section class="site-banner site-banner-compact relative rounded-3xl overflow-hidden bg-cover bg-center px-6 sm:px-10 py-10 sm:py-12 text-white shadow-xl bg-[url('https://images.unsplash.com/photo-1534536281715-e28d76689b4d?q=80&w=1920&auto=format&fit=crop')] border border-blue-900/40">
        ...
        <div class="relative z-10 max-w-3xl space-y-3">
          <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-xs font-bold uppercase tracking-wider text-cyan-200 border border-white/15">
            <Sparkles class="w-3.5 h-3.5 text-amber-300" /> 24/7 Support Team
          </span>
          <h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-white leading-tight">
            Get in Touch with ETEC Center Team
          </h1>
          <p class="text-sm sm:text-base text-slate-200 font-medium leading-relaxed">
            Have questions about job applications, hiring solutions, or platform features? Visit ETEC Center or message our dedicated team.
          </p>
        </div>
      </section>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div class="space-y-3">
            <div class="p-3 bg-[#0b1329]/10 dark:bg-slate-800 text-[#0b1329] dark:text-cyan-400 rounded-2xl w-12 h-12 flex items-center justify-center">
              <component :is="card.icon" class="w-6 h-6" />
            </div>
            <h3 class="font-extrabold text-slate-900 dark:text-white text-base">{{ card.title }}</h3>
            <p class="text-xs text-[#0b1329] dark:text-cyan-400 font-bold wrap-break-word">{{ card.value }}</p>
          ...
          <div v-if="card.action" class="pt-2">
            <a 
              ...
              class="inline-flex items-center gap-1.5 text-xs font-bold text-slate-700 dark:text-slate-300 hover:text-[#0b1329] dark:hover:text-cyan-400 transition"
            >
        ...
        <div class="lg:col-span-7 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-xs space-y-6">
          ...
          <div class="space-y-1.5 border-b border-slate-100 dark:border-slate-800 pb-4">
            <h2 class="text-xl font-extrabold text-slate-900 dark:text-white flex items-center gap-2">
              <MessageSquare class="w-5 h-5 text-[#0b1329] dark:text-cyan-400" />
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div class="space-y-1.5">
              ...
              <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
                <button
                  ...
                  class="py-2.5 px-3 rounded-xl text-xs font-bold border transition text-center cursor-pointer"
              ...
              <div class="space-y-1.5">
                ...
                <div class="relative">
                  ...
                  <input 
                    ...
                    required
                    class="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs sm:text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-[#0b1329] focus:ring-4 focus:ring-[#0b1329]/15 transition"
                  />
                </div>
              </div>
            ...
            <div class="space-y-1.5">
              ...
              <textarea 
                ...
                required
                class="w-full p-4 bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs sm:text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-[#0b1329] focus:ring-4 focus:ring-[#0b1329]/15 transition resize-none"
              ></textarea>
            </div>
            ...
            <button 
              ...
              class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl text-xs sm:text-sm transition duration-200 shadow-md shadow-blue-500/20 active:scale-95 disabled:opacity-50 cursor-pointer"
            >
              <Send class="w-4 h-4" />
        ...
        <div class="lg:col-span-5 space-y-6">
          ...
          <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
            ...
            <div class="space-y-2 border-b border-slate-100 dark:border-slate-800 pb-4">
              <span class="px-2.5 py-1 rounded-full bg-[#0b1329]/10 dark:bg-slate-800 text-[#0b1329] dark:text-cyan-400 text-[11px] font-bold uppercase tracking-wider">
                Headquarters & Training Campus
              </span>
              <h2 class="text-xl font-extrabold text-slate-900 dark:text-white flex items-center gap-2">
                <Building2 class="w-5 h-5 text-[#0b1329] dark:text-cyan-400" />
            ...
            <div class="space-y-4 text-xs text-slate-600 dark:text-slate-300">
              ...
              <div class="flex items-start gap-3">
                <div class="p-2.5 bg-[#0b1329]/10 dark:bg-slate-800 text-[#0b1329] dark:text-cyan-400 rounded-xl shrink-0 mt-0.5">
            ...
            <div class="rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 space-y-3">
              ...
              <div class="p-4 pt-1 text-center">
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-[#0b1329] hover:bg-[#142850] text-white rounded-xl text-xs font-bold shadow-md transition active:scale-95 cursor-pointer"
                >
          ...
          <div class="bg-[#0b1329]/5 dark:bg-slate-800/80 border border-[#0b1329]/15 dark:border-slate-700 p-5 rounded-3xl space-y-2">
            <h4 class="text-xs font-bold text-[#0b1329] dark:text-cyan-300 flex items-center gap-2">
              <ShieldCheck class="w-4 h-4 text-[#0b1329] dark:text-cyan-400" />
